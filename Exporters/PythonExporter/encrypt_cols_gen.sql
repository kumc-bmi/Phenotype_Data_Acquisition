...
replace(sql_str,
    ...
    ,'PROVIDER_NPI,'             ,'RAWTOHEX(standard_HASH("***encrypting_password"||PROVIDER_NPI,"SHA1")) PROVIDER_NPI,')
    ,'PATID,'                    ,'RAWTOHEX(standard_HASH("***encrypting_password"||he.patient_ide,"SHA1")) PATID,')
    ,'FACILITY_LOCATION,'        ,'RAWTOHEX(standard_HASH("***encrypting_password"||FACILITY_LOCATION,"SHA1")) FACILITY_LOCATION,')
    ,'FACILITYID,'               ,'RAWTOHEX(standard_HASH("***encrypting_password"||FACILITYID,"SHA1")) FACILITYID,')
    ,'RAW_PAYER_NAME_PRIMARY,'   ,'RAWTOHEX(standard_HASH("***encrypting_password"||RAW_PAYER_NAME_PRIMARY,"SHA1")) RAW_PAYER_NAME_PRIMARY,')
    ,'RAW_PAYER_ID_PRIMARY,'     ,'RAWTOHEX(standard_HASH("***encrypting_password"||RAW_PAYER_ID_PRIMARY,"SHA1")) RAW_PAYER_ID_PRIMARY,')
    ,'RAW_PAYER_NAME_SECONDARY,' ,'RAWTOHEX(standard_HASH("***encrypting_password"||RAW_PAYER_NAME_SECONDARY,"SHA1")) RAW_PAYER_NAME_SECONDARY,')
    ...
    ,'OBSCLIN_PROVIDERID,'       ,'RAWTOHEX(standard_HASH("***encrypting_password"||OBSCLIN_PROVIDERID,"SHA1")) OBSCLIN_PROVIDERID,')
    ,'OBSGEN_PROVIDERID,'        ,'RAWTOHEX(standard_HASH("***encrypting_password"||OBSGEN_PROVIDERID,"SHA1")) OBSGEN_PROVIDERID,')
    ,'RX_PROVIDERID,'            ,'RAWTOHEX(standard_HASH("***encrypting_password"||RX_PROVIDERID,"SHA1")) RX_PROVIDERID,')
